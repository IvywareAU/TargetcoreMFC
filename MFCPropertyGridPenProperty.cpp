...
IMPLEMENT_DYNAMIC(CMFCPropertyGridPenProperty, CMFCPropertyGridProperty)

CMFCPropertyGridPenProperty::CMFCPropertyGridPenProperty ( const CString& strName, LOGPEN& oLOGPEN
...
CMFCPropertyGridPenProperty::~CMFCPropertyGridPenProperty()
{
}
void
CMFCPropertyGridPenProperty::OnDrawValue ( CDC *pDC, CRect rect )
{
    MANAGE_RESOURCE_STATE;
AllowEdit();
...
void
CMFCPropertyGridPenProperty::OnClickButton(CPoint /*point*/)
{
    MANAGE_RESOURCE_STATE;
    ASSERT_VALID(this);
...
CString
CMFCPropertyGridPenProperty::FormatProperty ( )
{
    CString str;
...
void
CMFCPropertyGridPenProperty::ResetOriginalValue()
{
    CMFCPropertyGridProperty::ResetOriginalValue();
    m_oLOGPEN = m_oLOGPENorig;
}
BOOL
CMFCPropertyGridPenProperty::IsValueChanged() const
{
