...
//
//
//  CMFCPropertyGridFontcrxProperty implementations.
//  NOTES: Integrates LOGFONTcrx structure into CMFCPropertyGridCtrl
...
//       : Intention is to simply extend MFC with CMFCPropertyGridFontcrxProperty class
...
class CMFCPropertyGridFontcrxProperty : public CMFCPropertyGridFontProperty
{
    DECLARE_DYNAMIC(CMFCPropertyGridFontcrxProperty)

    // Construction
    public:
	      CMFCPropertyGridFontcrxProperty ( const CString& strName, LOGFONTcrx& oLOGFONTcrx
    ...
    public:
	    LOGFONTcrx*
        GetLogFontcrx();// { m_oLOGFONTcrx.oCOLORREF=m_Color; return &m_oLOGFONTcrx; }
	    //COLORREF GetColor() const { return m_Color; }
    protected:
	    LOGFONTcrx m_oLOGFONTcrx;
	    LOGFONTcrx m_oLOGFONTcrxorig;
