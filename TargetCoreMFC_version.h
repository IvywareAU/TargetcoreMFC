...
//         be traced back to a source state, which defeats the point. NOTE
//         that this repository carries no tags at all yet, so that is a rule
//         waiting on a first release rather than one currently held.
//
#pragma once
...
#define TARGETCOREMFC_VERSION_COMMAS 3,0,0,0
...
#define TARGETCOREMFC_VERSION_STRING "3.0.0.0"

//  Wide form, for the same reason - no stringising, nothing to drift.
#define TARGETCOREMFC_VERSION_STRINGW L"3.0.0.0"
...
#define TARGETCOREMFC_VERSION_HEX    0x03000000
